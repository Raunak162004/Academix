    ...
    <div className="fixed inset-0 z-[1000] !mt-0 grid h-screen w-screen place-items-center overflow-auto bg-white bg-opacity-10 backdrop-blur-sm">
      <div className="my-10 w-11/12 max-w-[700px] rounded-lg border border-richblack-400 bg-richblack-800">
        ...
        <div className="flex items-center justify-between rounded-t-lg bg-slate-700 p-5">
          <p className="text-xl font-semibold text-richblack-300">Add Review</p>
          ...
          >
            ...
            <div className="flex w-11/12 flex-col space-y-2">
              ...
              <textarea
                ...
                className="form-style resize-x-none min-h-[130px] w-full bg-richblack-900 text-white p-2 rounded-md border border-1-white"
              />
